 ...
 *
 */
@WebServlet(name="GetOrdersAllByUserServlet", urlPatterns="/GetOrdersAllByUserServlet")
public class GetOrdersAllByUserServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<Orders> orders = iOrdersService.getAllOrders(id);
