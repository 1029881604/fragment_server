 ...
 * 
 * @author 华文财
 * @time:2018年1月6日 下午3:11:39
 * @Description:TODO 附近板块信息fragment
 */
public class NearbyModularInfo {
	...
	private String type;
	private Timestamp needupdatetime;
	private Timestamp skillupdatetime;
	public NearbyModularInfo(String needtitle, String needbody, String needimg, String skilltitle, String skillbody,
			String skillimg, String type, Timestamp needupdatetime, Timestamp skillupdatetime) {
		super();
	...
	public Timestamp getNeedupdatetime() {
		return needupdatetime;
	}
	public void setNeedupdatetime(Timestamp needupdatetime) {
		this.needupdatetime = needupdatetime;
	}
	public Timestamp getSkillupdatetime() {
		return skillupdatetime;
	}
	public void setSkillupdatetime(Timestamp skillupdatetime) {
		this.skillupdatetime = skillupdatetime;
	}
	@Override
	public int hashCode() {
