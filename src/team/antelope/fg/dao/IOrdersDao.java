...
public interface IOrdersDao extends IBaseDao<Orders> {
	int addOrder(Long uid, Long uid_s, Long skillid, String title, String content, String img, String skilltype, double price, int ispay, int isdelete, int iscomment);
